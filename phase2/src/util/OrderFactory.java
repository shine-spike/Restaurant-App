...
public class OrderFactory {
    public static Order createOrder(int employeeNumber, int tableNumber, int customerIndex,
        ...
        for (String ingredientString : ingredientStrings.keySet()) {
            ingredients.put(restaurant.getInventory().getIngredient(ingredientString), ingredientStrings.get(ingredientString));
        }
